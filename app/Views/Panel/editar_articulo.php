...
<div class="container mt-3">
    ...
    <form class="row g-3" action="<?= base_url('actualizar_articulo') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="my-input shadow-none form-control p-1" name="nombre" value="<?= $articulo['nombre'] ?>" required>
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="number" step="0.01" class="my-input shadow-none form-control p-1" name="precio_prov" value="<?= $articulo['precio_prov'] ?>" required>
        </div>
        
        <div class="col-md-4">
            <label class="form-label">Precio Público</label>
            <input type="number" step="0.01" class="my-input shadow-none form-control p-1" name="precio_pub" value="<?= $articulo['precio_pub'] ?>" required>
        </div>
        
        <div class="col-md-4">
            <label class="form-label">Precio Distribuidor</label>
            <input type="number" step="0.01" class="my-input shadow-none form-control p-1" name="precio_dist" value="<?= $articulo['precio_dist'] ?>" required>
        </div>
        ...
        <div class="col-md-4">
            ...
            <?php if ($articulo['img']): ?>
                <div class="mb-2 mt-3">
		            <img src="<?= base_url('/ver_imagen/'.$articulo['img']) ?>" 
		                 class="img-thumbnail" 
