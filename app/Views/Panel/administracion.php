                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="orden in ordenes.dibujo" :key="orden.id_ot">
                                ...
                                <td>
                                    <!-- PEDIDO -->
                                    <a v-if="orden.tipo_origen === 'pedido' && orden.pedido_id"
                                    :href="'/ventas/ticket/' + orden.pedido_id"
                                    target="_blank"
                                    ...
                                    <!-- COTIZACIÓN -->
                                    <a v-else-if="orden.tipo_origen === 'cotizacion' && orden.pedido_id"
                                    :href="'/pagina_cotizador/' + orden.pedido_id"
                                    target="_blank"
                                    class="text-decoration-none">
                                        QT-{{ orden.pedido_id }}
                                    </a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="orden in ordenes.facturacion" :key="orden.id_ot">
                                ...
                                <td>
                                    <!-- PEDIDO -->
                                    <a v-if="orden.tipo_origen === 'pedido'" 
                                    :href="'/ventas/ticket/' + orden.pedido_id" 
                                    target="_blank" 
                                    class="text-decoration-none">
                                        {{ orden.pedido_id }}
                                    ...
                                    <!-- COTIZACIÓN -->
                                    <a v-else-if="orden.tipo_origen === 'cotizacion'" 
                                    :href="'/pagina_cotizador/' + orden.pedido_id" 
                                    target="_blank" 
                                    class="text-decoration-none">
                                        QT-{{ orden.pedido_id }}
