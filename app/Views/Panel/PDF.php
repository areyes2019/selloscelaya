    ...
    <table width="100%" style="font-family: sans-serif;" cellpadding="10">
        <tr>
            ...
            <td width="49%" style="border: 0.5mm solid #95a5a6; text-align: left;">
                ...
                <p><strong>Cotizacion No: <?php echo $key['id_cotizacion'] ?> </strong></p>   
            ...
            <td>
                ...
                <table width="30%" align="right" style="font-family: sans-serif; font-size: 14px; border-collapse: collapse;" >
                    <tr>
                        ...
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;">$<?php echo ($sub_total)  ?></td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;"><strong>Dcto</strong></td>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;"><?php echo ($descuento); ?></td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;"><strong>IVA</strong></td>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;">$<?php echo ($iva); ?></td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;"><strong>Total</strong></td>
                        <td style="border: 1px solid #95a5a6; padding: 10px 8px; line-height: 20px;">$<?php echo ($total)?></td>
                    </tr>
                </table>
            </td>
        </tr>
