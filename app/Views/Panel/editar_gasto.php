        ...
        <div class="col-md-6">
            <form action="/gastos/actualizar/<?= $gasto['id_registro']; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="monto" name="monto" value="<?= esc($gasto['monto']); ?>" required>
                </div>
                
                <div class="mb-3">
                    <label for="fecha_gasto" class="form-label">Fecha del Gasto</label>
                    <input type="date" class="form-control" id="fecha_gasto" name="fecha_gasto" value="<?= date('Y-m-d', strtotime($gasto['fecha_gasto'])); ?>" required>
                </div>
